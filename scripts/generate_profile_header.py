...
{svg_window_chrome(theme, 'theHerta27 / identity', ABOUT_SIZE[0], ABOUT_SIZE[1])}
  ...
  <text x="42" y="148" font-family="{SVG_MONO_FONT}" font-size="22"><tspan fill="{theme['text']}">Tan Junlin</tspan><tspan fill="{theme['secondary']}"> | </tspan><tspan fill="{theme['underline']}" font-family="{SVG_CJK_FONT}" font-size="21">把想法做成系统</tspan><tspan fill="{theme['underline']}" font-family="{SVG_MONO_FONT}"> · Turn Ideas into Systems</tspan></text>
...
{svg_window_chrome(theme, 'theHerta27 / identity', ABOUT_MOBILE_SIZE[0], ABOUT_MOBILE_SIZE[1])}
  ...
  <text x="42" y="151" font-family="{SVG_MONO_FONT}" font-size="23"><tspan fill="{theme['text']}">Tan Junlin</tspan><tspan fill="{theme['secondary']}"> | </tspan><tspan fill="{theme['underline']}" font-family="{SVG_CJK_FONT}" font-size="22">把想法做成系统</tspan></text>
  <text x="42" y="187" fill="{theme['underline']}" font-family="{SVG_MONO_FONT}" font-size="23">· Turn Ideas into Systems</text>
...
def about_preview_image(theme_name: str) -> Image.Image:
    ...
    draw.text((identity_x, 119), "把想法做成系统", font=ABOUT_CJK_FONT, fill=theme["underline"])
    identity_x += draw.textlength("把想法做成系统", font=ABOUT_CJK_FONT)
    draw.text((identity_x, 119), " · Turn Ideas into Systems", font=ABOUT_IDENTITY_FONT, fill=theme["underline"])
...
def about_mobile_preview_image(theme_name: str) -> Image.Image:
    ...
    identity_x += draw.textlength(" | ", font=ABOUT_IDENTITY_FONT)
    draw.text((identity_x, 121), "把想法做成系统", font=ABOUT_CJK_FONT, fill=theme["underline"])
    draw.text((42, 157), "· Turn Ideas into Systems", font=ABOUT_IDENTITY_FONT, fill=theme["underline"])
